...
public class Corl extends SubsystemBase {
    ...
    public TalonFX turboMotor = new TalonFX(Constants.Motors.turboMotor); // Assigning a unique ID for the turbo motor
    ...
    public Corl() {
        ...
        turboMotor.getConfigurator().apply(new TalonFXConfiguration().withCurrentLimits(limitConfigs3).withMotorOutput(inverConfig));
