...
//    // public static final Algae ALGAE = new Algae();
  public static final NewIntake INTAKE = new NewIntake();
//    private final Command algaeAutomaticIn = new rotateBackToHardstop(ALGAE);
  ...
  SwerveInputStream driveDirectAngle = driveAngularVelocity.copy()
      .withControllerHeadingAxis(
          () -> (drivebase.isRedAlliance() ? driverXbox.getRightX() : driverXbox.getRightX() * -1),
...
//    // private final Command GoToHumanPlayerSetpoint = new GoToSetpoint(CORL,
//    // Constants.Setpoints.HumanRotator, Constants.Setpoints.HumanIntake);
//    // private final Command GoToHighCorlSetpoint = new GoToSetpoint(CORL,
//    // Constants.Setpoints.HighRotator, Constants.Setpoints.HighIntake );
...
//  //      NamedCommands.registerCommand("HumanPlayerPose", new GoToSetpoint(CORL, Constants.Setpoints.HumanElevator,
//          Constants.Setpoints.HumanRotator, Constants.Setpoints.HumanIntake).withTimeout(2.0));
//  //      NamedCommands.registerCommand("ArmScoot", new GoToSetpoint(CORL, Constants.Setpoints.LowElevator,
//          Constants.Setpoints.LowRotator, Constants.Setpoints.LowIntake).withTimeout(2.0));
    // NamedCommands.registerCommand("ArmVertical",
//  //          new GoToSetpoint(CORL, Constants.Setpoints.LowElevator, Constants.Setpoints.LowRotator, 2.0).withTimeout(2.0));
//  //      NamedCommands.registerCommand("ArmAlgae", new GoToSetpoint(CORL, Constants.Setpoints.algaeElevatorMid,
//          Constants.Setpoints.algaeArmMid, Constants.Setpoints.algaeIntakeMid).withTimeout(2.0));
...
//              Constants.Setpoints.L1Intake).withTimeout(2.0));
...
// //      // NamedCommands.registerCommand("SetpointHigh", new GoToSetpoint(CORL, 0, 0,
//     // 0));
// //      // NamedCommands.registerCommand("SetpointDown", new GoToSetpoint(CORL, 0, 0,
//     // 0));
// //      // NamedCommands.registerCommand("SetpointMid", new GoToSetpoint(CORL, 0, 0,
//     // 0));
...
//     autoChooser = AutoBuilder.buildAutoChooser();
  ...
  private void configureBindings() {
    ...
    if (DriverStation.isTest()) {
      ...
      // driverXbox.rightBumper().whileTrue(new goToPosition(-20,
//        // ALGAE,-0.4)).onFalse(algaeAutomaticIn);
      driverXbox.rightTrigger().whileTrue(drivebase.reverseAlignMode(() -> driverXbox.getLeftX(),
          () -> driverXbox.getLeftY(), () -> driverXbox.getRightX()));
    ...
    oppXbox.leftBumper().onTrue(INTAKE.Rotate_Goto(1)).onFalse(INTAKE.Rotate_Goto(0));
    oppXbox.rightBumper().onTrue(INTAKE.Rotate_Goto(2)).onFalse(INTAKE.Rotate_Goto(0));
...
//        oppXbox.rightTrigger().whileTrue(CORL.runIntake(-0.85)).onFalse(CORL.runIntake(0.0));
      ...
      // driverXbox.x().whileTrue(new AlignWithApriltag(drivebase,
      // drivebase.bestTargetID()));
